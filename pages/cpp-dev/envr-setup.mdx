...
Now that you have VSCode open, you can start writing C++ code. We recommend would create another folder inside of the one you are using for the class, and call it `testing` or something similar. Then, just add a `main.cpp` file where you will write your code.
