---
title: MySQL
description: This section provides an overview of using MySQL.
---
...
1. Open a terminal and run the following command to pull the latest MySQL image from Docker Hub
    ```bash
...
- [5 Server VS Code Extension](https://marketplace.visualstudio.com/items?itemName=yandeu.five-server)
- [Docker](https://www.docker.com/products/docker-desktop)
- Docker MySQL Setup
