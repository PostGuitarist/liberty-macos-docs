...
![File explorer with a testing folder and a file inside it named main.cpp](/public/file-explorer.png)
...
![List of extensions to install](/public/extensions.png)
...
![Run Code Button](/public/runcode.png)
