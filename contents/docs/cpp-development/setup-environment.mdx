...
description: This section provides an overview of setting up a C++ development environment.
---
...
If you head to the [download link](https://code.visualstudio.com/Download) and click either the ***Apple silicon*** or ***Intel chip*** version (depending on how new your Mac is).
...
Now that you have VS Code open, you can start writing C++ code. We recommend creating another folder inside of the one you are using for the class, and calling it `testing` or something similar. Then, just add a `main.cpp` file where you will write your code.
